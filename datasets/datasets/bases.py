...
from utils.iotools import read_rgb_image
...
if __name__ == "__main__":
    from datasets.datasets import AICity
    from utils.visualize import visualize_img
    from datasets.demo_transforms import get_training_albumentations
