...
cfg.test.model_path = "./checkpoints/veri776_reid.pth"
cfg.test.color_clf_model_path = './checkpoints/color_model.pth'
cfg.test.vehicle_clf_model_path = './checkpoints/vehicle_type.pth'
cfg.test.color_type_json = './configs/color.json'
cfg.test.vehicle_type_json = './configs/vehicle.json'
cfg.test.max_rank = 50
cfg.test.rerank = False
cfg.test.lambda_ = 0.0
cfg.test.output_html_path = ""
cfg.test.infer_flag = False  ## inference flag
...
cfg.parse = CfgNode()
cfg.parse.model_path = './checkpoints/parsing_model.pth'
